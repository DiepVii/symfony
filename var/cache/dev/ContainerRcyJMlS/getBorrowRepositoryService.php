 ...
 */
class getBorrowRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BorrowRepository' shared autowired service.
     *
     * @return \App\Repository\BorrowRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BorrowRepository.php';

        return $container->privates['App\\Repository\\BorrowRepository'] = new \App\Repository\BorrowRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
